...
- (id)init {
   ...
   if (self) {
      ...
      // the second element is the thumbnail URL.
       ...
       NSURL *url = [NSURL URLWithString:@"http://10.2.17.151:8080/CNB/webresources/image/photo/url"];
       ...
       if (!error) {
           ...
           NSLog(@"vPhotoalbum buf=\n%@",[rootBuf objectForKey:@"vPhotoalbum"]);
           NSArray *arr = (NSArray *)[rootBuf objectForKey:@"vPhotoalbum"];
